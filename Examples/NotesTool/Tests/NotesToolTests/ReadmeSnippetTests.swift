...
/// Verifies the "guide examples compile" acceptance criterion:
/// every `<!-- doc-snippet source="..." --> ``` ... ``` <!-- /doc-snippet -->`
/// code block in `docs/GUIDE.md` is a genuine, contiguous excerpt of the
/// source file it cites, not hand-written pseudocode that could drift out of
/// sync with what actually compiles. The full declare/fuse/serve/CLI
/// walkthrough lives in `docs/GUIDE.md`; this package's root `README.md`
/// documents the Extras package as a whole and carries no snippets.
///
...
struct ReadmeSnippetTests {
    ...
    private static let docFiles = ["docs/GUIDE.md"]
    ...
    @Test("the guide documents all four declare/fuse/serve/CLI stages from real NotesTool source")
